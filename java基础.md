...
[复制代码](https://www.nowcoder.com/study/live/660/3/2#)
...
![img](img/java基础/collection.jpg)

Map体系的继承树：

![img](img/java基础/map.jpg)
...
![img](img/java基础/hashmap-1.png)

因此元素在重新计算hash之后，因为n变为2倍，那么n-1的mask范围在高位多1bit(红色)，因此新的index就会发生这样的变化：

![img](img/java基础/hashmap-2.png)

因此，我们在扩充HashMap的时候，不需要重新计算hash，只需要看看原来的hash值新增的那个bit是1还是0就好了，是0的话索引没变，是1的话索引变成“原索引+oldCap”。可以看看下图为16扩充为32的resize示意图：

![img](img/java基础/hashmap-3.png)
...
![img](img/java基础/concurrenthashmap-1.png)
...
![img](img/java基础/concurrenthashmap-2.png)
...
![img](img/java基础/linkedhashmap-1.jpg)
...
![img](img/java基础/condition-1.png)
...
![img](img/java基础/condition-2.png)
...
![img](img/java基础/reentrantlock.png)
...
![img](img/java基础/reentrantlock-2.jpg)
...
![img](img/java基础/objhead64.png)

在32位的虚拟机中：

![img](img/java基础/objhead32.png)
...
![img](img/java基础/threadpool-2.png)
...
![img](img/java基础/threadpool-1.png)
...
![img](img/java基础/obj-1.png)

具有父类的子类的实例化顺序如下：

![img](img/java基础/obj-2.png)
...
![img](img/java基础/classloader.jpg)
...
![](img/java基础//QQ图片20210730165302.jpg)